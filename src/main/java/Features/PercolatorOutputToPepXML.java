...
public class PercolatorOutputToPepXML {
    public static void main(final String[] args) {
        if (args.length == 0)
            percolatorToPepXML(
                    Paths.get("C:/Users/kevin/Downloads/proteomics/cptac/2021-2-21/CPTAC_CCRCC_W_JHU_LUMOS_C3L-01665_T.pin"),
                    Paths.get("C:/Users/kevin/Downloads/proteomics/cptac/2021-2-21/CPTAC_CCRCC_W_JHU_LUMOS_C3L-01665_T"),
                    ".pepXML",
                    Paths.get("C:/Users/kevin/Downloads/proteomics/cptac/2021-2-21/perc/detectTarget.tsv"),
                    Paths.get("C:/Users/kevin/Downloads/proteomics/cptac/2021-2-21/perc/detectDecoy.tsv"),
                    Paths.get("C:/Users/kevin/Downloads/proteomics/cptac/2021-2-21/perc/testdetect"),
                    ".pep.xml");
        else
            percolatorToPepXML(
                    Paths.get(args[0]),
            ...
            try (final BufferedReader brpepxml = Files.newBufferedReader(pepxml_rank);
                ...
                while ((line = brpepxml.readLine()) != null) {
                    if (line.trim().startsWith("<spectrum_query")) {
                        ...
                        //System.out.println(Arrays.toString(pep_score));
